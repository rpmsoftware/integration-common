...
const { toArray, toBoolean, validatePropertyConfig, getDeepValue } = require('integration-common/util');
const { init: initCondition, process: processCondition } = require('integration-common/conditions');
